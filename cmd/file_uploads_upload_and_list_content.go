...
Arguments:
  datasource-id: required`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if fileUploadsUploadAndListContentFile == "" && term.IsTerminal(int(os.Stdin.Fd())) {
			...
			fileUploadsUploadAndListContentFile = pathutil.Expand(fileUploadsUploadAndListContentFile)
		}
		...
		opts := &sdk.FileUploadsUploadAndListContentOptions{}
		if fileUploadsUploadAndListContentTriggerIngest {
			opts.TriggerIngest = &fileUploadsUploadAndListContentTriggerIngest
		}
