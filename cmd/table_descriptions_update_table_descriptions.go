...
Arguments:
  datasource-id: required`,
	...
	Example: "meibel datasources table-descriptions update <datasource-id>",
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := client.Datasources.TableDescriptions.UpdateTableDescriptions(ctx, datasourceId, body)
		if err != nil {
			return err
		}
