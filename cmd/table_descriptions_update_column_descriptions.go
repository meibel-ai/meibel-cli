...
Arguments:
  ...
  table-name: required`,
	...
	Example: "meibel table-descriptions update-column <datasource-id> <table-name>",
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := client.TableDescriptions.UpdateColumnDescriptions(ctx, datasourceId, tableName, body)
		if err != nil {
			return err
		}
